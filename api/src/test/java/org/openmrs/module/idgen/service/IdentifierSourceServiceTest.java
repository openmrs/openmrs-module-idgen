...
public class IdentifierSourceServiceTest extends IdgenBaseTest {
    ...
    public void getIdentifierSource_shouldReturnASavedIdentifierPool() throws Exception {
		...
		Assert.assertEquals(idpool.getBatchSize(), (Integer)1000);
    ...
    public void shouldGenerateIdentifier() {
        String identifier = iss.generateIdentifier(iss.getIdentifierSourceByUuid("0d47284f-9e9b-4a81-a88b-8bb42bc0a907"), "New HIV Patient");
        Assert.assertEquals("MRS000011", identifier);
    }

    @Test
    public void shouldGetSequenceValue() {
        SequentialIdentifierGenerator sequentialIdentifierGenerator = (SequentialIdentifierGenerator)
                iss.getIdentifierSourceByUuid("0d47284f-9e9b-4a81-a88b-8bb42bc0a907");

        long sequenceValue = iss.getSequenceValue(sequentialIdentifierGenerator);
        Assert.assertEquals((long) 11, sequenceValue);
    }
    ...
    public void shouldSaveSequenceValue() throws Exception {
        ...
        String seqGeneratorName = "Local Sequential Generator";
        sequentialIdentifierGenerator.setName(seqGeneratorName);
        iss.saveSequenceValue((SequentialIdentifierGenerator)
                iss.getIdentifierSourceByUuid("0d47284f-9e9b-4a81-a88b-8bb42bc0a907"), (long) 12345);

        long sequenceValue = iss.getSequenceValue((SequentialIdentifierGenerator)
                iss.getIdentifierSourceByUuid("0d47284f-9e9b-4a81-a88b-8bb42bc0a907"));
        Assert.assertEquals((long) 12345, sequenceValue);
    }
