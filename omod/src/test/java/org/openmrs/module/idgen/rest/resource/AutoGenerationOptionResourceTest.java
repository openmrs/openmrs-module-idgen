...
public class AutoGenerationOptionResourceTest extends BaseDelegatingResourceTest<AutoGenerationOptionResource, AutoGenerationOption> {
	...
	public void validateDefaultRepresentation() throws Exception {
		...
		assertPropEquals("location", getObject().getLocation().getUuid());
		assertPropEquals("identifierType", getObject().getIdentifierType().getUuid());
		assertPropEquals("source", getObject().getSource().getUuid());
