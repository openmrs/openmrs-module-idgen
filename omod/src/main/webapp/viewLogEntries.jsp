	...
	<form method="get">
		<table width="100%" id="searchTable">
			<tr>
				...
				<td width="100%"><input type="text" name="identifier" value="${ui.encodeHtmlAttribute(identifier)}"/></td>
			</tr>
			<tr>
				...
				<td width="100%"><input type="text" name="comment" value="${ui.encodeHtmlAttribute(comment)}"/></td>
			</tr>
			<tr>
