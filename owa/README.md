...
This will build and deploy the app to the `/Users/adamskariuki/Downloads/referenceapplication-standalone-2.6.0/appdata//owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/adamskariuki/Downloads/referenceapplication-standalone-2.6.0/appdata//owa"
}
```
