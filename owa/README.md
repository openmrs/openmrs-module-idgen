...
This will build and deploy the app to the `/Users/andeladeveloper/.OpenMRS/owa`
...
```js
{
  "LOCAL_OWA_FOLDER": "/Users/andeladeveloper/.OpenMRS/owa"
}
```
...
{
  "LOCAL_OWA_FOLDER": "/Users/andeladeveloper/.OpenMRS/owa",
  "APP_ENTRY_POINT": "http://localhost:8080/openmrs/owa/openmrs-owa-idgen/index.html"
}
```
